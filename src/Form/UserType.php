...
class UserType extends AppType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('mdp',PasswordType::class,$this->conf("Mot de pass :", "Votre mot de pass"))
            ->add('confirmation',PasswordType::class,$this->conf("Confirmation de mot de pass :", "Veuillez confirmer votre mot de pass"))
